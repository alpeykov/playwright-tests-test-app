...
const logFilePath = path.join(__dirname, 'logs', 'log_tests.txt');
...
function writeLog(message) {
    ...
    const logFilePath = path.join(logDir, 'log_tests.txt');
...
describe("e2e tests", () => {
    ...
    describe("authentication", () => {
        test(`#1 Registration`, async ({ page }) => {
            ...
            writeLog(JSON.stringify(userData));
    ...
    describe("CRUD", () => {
        ...
        test(`#6 Create Album`, async ({ page }) => {
            ...
            writeLog(JSON.stringify(albumData));
            ...
            writeLog(JSON.stringify(lastCreatedId));
        });
        ...
        test(`#8 Delete album`, async ({ page }) => {
            ...
            writeLog(JSON.stringify(deletedAlbum));
        });
    });
});
